# Agro_Mapping
AgroMapping é uma aplicação web que mapeia feiras agrícolas e facilita a reserva de frutas e verduras diretamente dos produtores locais. O objetivo é conectar consumidores com feirantes de forma prática.

...
public class UsuarioController implements UsuarioSwagger {
    ...
    public ResponseEntity<UsuarioResponseDTO> getUsuarioComContatos(@PathVariable UUID id) {
        UsuarioResponseDTO usuarioDTO = usuarioServiceInterface.buscarUsuarioPorId(id).orElseThrow();

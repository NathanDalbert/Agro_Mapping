...
public class EstoqueController  {
    ...
    public ResponseEntity<EstoqueResponseDTO> criarEstoque(@Valid @RequestBody EstoqueRequestDTO estoqueRequestDTO) {
        EstoqueResponseDTO estoqueResponseDTO = estoqueServiceInterface.criarEstoque(estoqueRequestDTO);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EstoqueResponseDTO> buscarEstoquePorId(@PathVariable UUID id) {
        EstoqueResponseDTO estoqueResponseDTO = estoqueServiceInterface.buscarEstoquePorId(id);
        return ResponseEntity.ok(estoqueResponseDTO);
    }
